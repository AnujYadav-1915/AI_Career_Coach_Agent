...
//           className="text-gray-500 hover:bg-gray-200 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 gradient-button-bg text-white shadow-sm"
...
//         {/* Contact Info */}
//         <div className="bg-white rounded-lg shadow-sm p-5 border border-green-200 relative overflow-hidden group">
...
//         {/* Education */}
//         <div className="bg-white rounded-lg shadow-sm p-5 border border-yellow-200 relative overflow-hidden group">
//           <h4 className="text-lg font-semibold text-gray-700 mb-3">
...
//         {/* Skills */}
//         <div className="bg-white rounded-lg shadow-sm p-5 border border-red-200 relative overflow-hidden group">
//           <h4 className="text-lg font-semibold text-gray-700 mb-3">
