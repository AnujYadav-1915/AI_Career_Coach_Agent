...
function TurboNode({data}:any){
    return (
        <div className='rounded-lg border-gray-300 bg-blue-100 shadow-sm w-64'>
            ...
            <Link href = {data?.link} target='_blank' className='text-black underline text-sm mt-2 inline-block'>
            Learn More
            </Link>
