...
function getImageKitClient() {
  ...
  const urlEndpoint = process.env.IMAGE_ENDPOINT_URL;

  if (!publicKey || !privateKey || !urlEndpoint) {
    throw new Error("Missing ImageKit configuration. Set IMAGEKIT_PUBLIC_KEY, IMAGEKIT_PRIVATE_KEY, and IMAGE_ENDPOINT_URL.");
  }
